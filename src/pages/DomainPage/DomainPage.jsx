...
const DomainPage = ({
    ...
    useEffect(() => {
        if (registrantContacts?.ident?.type === "org") {
            if (companies.isLoading === null) {
                ...
                setIsLockable(
                    domain.isLockable &&
                        companies.data[registrantContacts.ident.code]
                )
            }
        }
    ...
    useEffect(() => {
        if (domain?.tech_contacts) {
            const userContact = Helpers.getUserContacts(
                user,
                domain,
                contacts,
                companies
                    ...
                    <Container textAlign='center'>
                        <div className='page--header--actions'>
                            <Button
                                as={Link}
                                content={
                                    <FormattedMessage id='domain.changeContacts' />
                                }
                                ...
                                <Table.Body>
                                    ...
                                    {registrantContacts.email && (
                                        <Table.Row>
                                            ...
                                            <Table.Cell>
                                                <a
                                                    href={`mailto:${registrantContacts.email}`}
                                                >
                                                    {registrantContacts.email}
                                                </a>
                                            </Table.Cell>
                ...
                <div className='page--block'>
                    <Container text>
                        ...
                        <Table basic='very'>
                            ...
                            <Table.Body>
                                <DomainContacts
                                    contacts={domain.tech_contacts.map(
                                        (item) => ({
                                            ...item,
                                            ...contacts[item.id],
                                        })
                                ...
                                />
                                <DomainContacts
                                    contacts={domain.admin_contacts.map(
                                        (item) => ({
                                            ...item,
                                            ...contacts[item.id],
                                        })
                                ...
                                <Table.Row>
                                    ...
                                    <Table.Cell>
                                        ...
                                        domain.registrar.website ? (
                                            <a
                                                href={
                                                    domain.registrar.website.indexOf(
                                                        "http"
                                                    ) > -1
                                                        ? domain.registrar
                                                              .website
