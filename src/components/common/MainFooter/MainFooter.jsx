    ...
    const menu = footer.reduce((acc, item) => {
        if (item.language.code === lang) {
            const body = item.text.body
                .split('href="/')
                .join('href="https://www.internet.ee/')
            return [
                ...acc,
                {
                    body,
            ...
            <div className='footer-top'>
                ...
                <div className='footer-contacts'>
                    <div className='address'>
                        ...
                        <p>
                            <a
                                href='https://goo.gl/maps/1FiwD8m5B8y'
                                target='_self'
                            >
                    ...
                    <ul className='quickinfo'>
                        <li>
                            <Icon name='envelope' />
                            <a href='mailto:info@internet.ee'>
                                info@internet.ee
                            </a>
                        </li>
                        <li>
            ...
            <div className='footer-bottom'>
                ...
                <nav className='menu-social'>
                    ...
                    <ul>
                        <li>
                            <a
                                href='https://www.facebook.com/EE-748656818569233/'
                                title='Facebook'
                            >
                                <Icon name='facebook' />
                            </a>
                        ...
                        <li>
                            <a
                                href='https://twitter.com/Eesti_Internet'
                                title='Twitter'
                            >
                                <Icon name='twitter' />
                            </a>
