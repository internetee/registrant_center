...
class DomainGridItem extends Component {
  ...
  render() {
    ...
    const { domain, contacts, lang } = this.props;
    if (domain) {
      moment.locale(lang);
      return (
                ...
                <div className='extra'>
                  ...
                  <div className="table-wrap">
                    <Table basic='very' compact size='small' unstackable>
                      ...
                      <Table.Body>
                        <DomainContacts contacts={contacts} domain={domain} />
                      </Table.Body>
                    </Table>
                  </div>
                  <h5>
...
const DomainContacts = ({ contacts, domain }) => {
  const filteredContacts = Helpers.getDomainContacts(domain, contacts);
  const role = (roles) => {
    if (roles.has('admin')) {
      return (
        <FormattedMessage
